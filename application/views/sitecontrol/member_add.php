...
<div class="content-wrapper">
    ...
    <div class="col-xs-12">
        <div class="box">
            ...
            <hr>
            <div class="col-xs-12">
                <?PHP echo form_open_multipart('sitecontrol/member/insert', 'onsubmit="return form_member()"'); ?>
                <div class="row">
<!--                    <div class="form-group col-sm-6">
                        <img src="<?PHP echo base_url('assets_sitecontrol/img/default.jpg'); ?>" class="avatar" id="pics" alt="avatar" width="200" height="200">
                    </div>
                    <div class="form-group col-sm-6">
                        <label>Picture</label>
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <select name="level" id="level" class="selectpicker" data-width="100%" required data-live-search="true" required style="position:absolute; top:55px; width:1px; height:1px; display:inline-block !important; opacity:0; ">
                            ...
                            if (isset($level)) {
                                foreach ($level as $lv) {
                                    ?>
                                    <option value="<?PHP echo $lv['level_id']; ?>"><?PHP echo $lv['level_name']; ?></option>
                                    <?PHP
                                }
                            }
                            ?>
...
<!--                    <div class="form-group col-sm-6">
                        ...
                        <input type="text" name="mem_id" id="mem_id" class="form-control" placeholder="ID" required>
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input type="text" name="mobile" id="mobile" class="form-control" maxlength="10" placeholder="Mobile" onkeypress="CheckNum()" required>
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <span id="text_username" style="color:red"><br>กรุณาระบุชื่อเข้าระบบ</span>
                    </div>
                    <div class="form-group col-sm-4">
                        <label>Password <span style="color:red">*</span></label>
                        <input type="text" name="password" id="password" class="form-control" placeholder="Password" required>
                        <span id="text_pass" style="color:red"><br>กรุณาระบุรหัสผ่าน</span>
                    ...
                    <!--<div class="form-group col-sm-6">
                        ...
                        <span id="text_confirm_pass" style="color:red"><br>กรุณาระบุยืนยันรหัสผ่าน</span>
                    </div>-->
                    <!--<div class="form-group col-sm-6">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <select name="zone_id" class="selectpicker" data-width="100%">
                            ...
                            if (isset($zone_list)) {
                                foreach ($zone_list as $zone) {
                                    ?>
                                    <option value="<?PHP echo $zone['zone_id']; ?>"><?PHP echo $zone['zone_code'] ?></option>
                                    <?PHP
                                }
                            }
                            ?>
