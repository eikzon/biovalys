...
<div class="content-wrapper">
    <div class="content-header">
        <div class="col-xs-8">
            <h1><i class="fa fa-file-text-o fa-lg"></i> SO</h1>
            <ol class="breadcrumb">
    ...
    <div class="col-xs-12">
        <div class="box">
            ...
            <div class="col-xs-12 filter-form">
                <?PHP echo form_open('sitecontrol/report/report_so'); ?>
                <div class="row">
                    ...
                    <div class="form-group col-sm-3">
                        ...
                        <?PHP if (!empty($search['name']) || !empty($search['type']) || !empty($search['province'])) { ?>
                            &nbsp;&nbsp;
                            <button type="button" class="btn btn-default btn-search" onclick="window.location = '<?PHP echo base_url("sitecontrol/report/report_so") ?>/refresh'"><i class="fa fa-refresh"></i> Show All</button>
                        <?PHP } ?>
                    </div>
                </div>
                <?PHP echo form_close(); ?>
                ...
                <table class="table table-hover table-striped" style="table-layout: fixed;">
                    <thead>
                        <tr>
                            ...
                            <th width="130px" class="text-center">Sales Order No.</th>
                            <th width="130px">SO issued Date</th>
                            <th width="100px">Invoice No.</th>
                            <th width="130px">IV issued Date</th>
                            <th width="100px">Order as of</th>
                            <th width="150px">Product</th>
                            <th width="50px">Rep.ID</th>
                            <th width="50px">Area</th>
                            <th width="60px">Rep.ID by C&I</th>
                            <th width="80px">Cust.ID</th>
                            <th width="150px">Customer Type</th>
                            <th width="100px">Military Hospital<br/>(Yes/No)</th>
                            ...
                            <th width="100px">AR submit Date</th>
                            <th width="50px">M</th>
                            <th width="50px">Y</th>
                            <th width="100px">Rebate Paid<br/>(1/0)</th>
                            <th width="100px">RSR issued Date</th>
                            <th width="50px">M</th>
                            <th width="50px">Y</th>
                    ...
                    <tbody>
                        <?PHP
                        if (count(@$report_so_index) > 0) {
                            $i = 1;
                            foreach ($report_so_index as $rsoi) {
                                ?>
                                <tr>
                                    <td class="text-center"><?php echo $i;?></td>
                                    <td class="text-center"><?PHP echo @$rsoi['order_number']; ?></td>
                                    <td class="text-center"><?PHP echo date('d M y', strtotime(@$rsoi['order_create_date'])); ?></td>
                                    <td class="text-center"><?PHP echo @$rsoi['order_number']; ?></td>
                                    <td class="text-center"><?PHP echo date('d M y', strtotime(@$rsoi['order_create_date'])); ?></td>
                                    <td class="text-center"><?PHP echo date('Ym', strtotime(@$rsoi['order_create_date'])); ?></td>
                                    <td class="text-center"><?PHP echo @$rsoi['product_name']; ?></td>
                                    <td class="text-center"><?PHP echo @$rsoi['zone_code']; ?></td>
                                    <td class="text-center"><?PHP echo @$rsoi['area_name']; ?></td>
                                    <td class="text-center"><?PHP echo @$rsoi['zone_code']; ?></td>
                                    <td class="text-center"><?PHP echo sprintf('%05d', @$rsoi['customer_id']); ?></td>
                                    <td class="text-center"><?PHP echo @$rsoi['cus_type_name']; ?></td>
                                    <td class="text-center"><?php echo (@$rsoi['customer_military'] == 1)?'Yes':'No';?></td>
                                    <td class="text-center"><?PHP echo @$rsoi['customer_name']; ?></td>
                                    <td class="text-center"><?PHP echo @$rsoi['province_name']; ?></td>
                                    <?php
                                        if(count($product_list) > 0){
                                            foreach($product_list as $th => $thead_prod){
                                                if($th == 0){
